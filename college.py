...
question_vectors = vectorizer.fir_transform(df['Question'])
...
#Function to find the closest qustion using cosine similarity
def find_closest_question(user_query , vectorizer , qusetion_vectors, df):
...
if prompt := st.chat_input("Type your question here..."):
  ...
  closest_answer = find_closest_qusetion(prompt , vectorizer ,question_vectors , df)
  if closest_answer:
